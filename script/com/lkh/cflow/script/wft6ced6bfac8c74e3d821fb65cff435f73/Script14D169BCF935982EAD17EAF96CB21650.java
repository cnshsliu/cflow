package com.lkh.cflow.script.wft6ced6bfac8c74e3d821fb65cff435f73;
...
public class Script14D169BCF935982EAD17EAF96CB21650{
AccessControlContext _accessControlContext;
	public static void main(String[] args){
		try{
			JSONParser parser = new JSONParser();
			JSONObject ctx = (JSONObject)parser.parse(args[0]);
			Script14D169BCF935982EAD17EAF96CB21650 me=new Script14D169BCF935982EAD17EAF96CB21650();
...
public void setPermissions(Collection<Permission> permissionCollection) {
	...
	String fullScript = json2 + "function cfoooooooFunction() { var data= new Object(); if(days>10) \n    data.RETURN=\"long\"; \nelse\n    data.RETURN=\"short\";\nvar r = new java.io.FileReader(\"C:\\\\cflow\\\\hello.xml\");\ndata.myContextValue=\"myvalue\"; return (data.toJSONString());}";

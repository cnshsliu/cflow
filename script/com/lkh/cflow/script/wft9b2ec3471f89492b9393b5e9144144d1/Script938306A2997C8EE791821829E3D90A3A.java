package com.lkh.cflow.script.wft9b2ec3471f89492b9393b5e9144144d1;
...
public class Script938306A2997C8EE791821829E3D90A3A{
AccessControlContext _accessControlContext;
	public static void main(String[] args){
		try{
			...
			Script938306A2997C8EE791821829E3D90A3A me=new Script938306A2997C8EE791821829E3D90A3A();
...
public void setPermissions(Collection<Permission> permissionCollection) {
	...
	String fullScript = json2 + "function cfoooooooFunction() { var data= new Object(); data.intkey = intkey + 1;\ndata.textkey = textkey + \"--tail\";\ndata.urlkey = urlkey + \"--tail\";\ndata.floatkey=floatkey + 3.2; return (data.toJSONString());}";

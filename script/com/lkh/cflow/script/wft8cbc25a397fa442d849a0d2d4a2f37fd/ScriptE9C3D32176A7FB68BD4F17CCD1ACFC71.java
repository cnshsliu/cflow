...
public class ScriptE9C3D32176A7FB68BD4F17CCD1ACFC71{
AccessControlContext _accessControlContext;
	public static void main(String[] args){
		try{
			...
			ScriptE9C3D32176A7FB68BD4F17CCD1ACFC71 me=new ScriptE9C3D32176A7FB68BD4F17CCD1ACFC71();
...
public void setPermissions(Collection<Permission> permissionCollection) {
	...
	String fullScript = json2 + "function cfoooooooFunction() { var data= new Object(); data.msg=\"主动营销已按所选方案自动执行:\";\ndata.msg +=\"<BR>向\"+ usersG1 + \"发送\" + methodG1;\ndata.msg += \"<BR>向\" + usersG2+ \"发送\" + methodG2;\ndata.RETURN=\"DEFAULT\";\ndata.checkRound=0; return (data.toJSONString());}";

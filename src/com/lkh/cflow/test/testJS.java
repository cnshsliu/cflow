...
public class testJS {
	...
	private void runMe(String[] args) {
		...
		String myscript = "var ret = new Object(); ret.RETURN=1; ret.RETURN_TO_PARENT=\"hello\"; return (ret.toJSONString());";
		String script = json2 + "\nfunction cfF(){" + myscript + "} return cfF();";
		try {

			Object tmpret = CflowHelper.scriptHandler.runScript(script, kvs);
			String returnedJSONString = tmpret.toString();
			System.out.println(returnedJSONString);
			JSONParser parser = new JSONParser();
			JSONObject obj = (JSONObject) parser.parse(returnedJSONString);
			System.out.println(obj.get("RET"));
			System.out.println(obj.get("RETURN"));
			System.out.println(obj.get("RETURN_TO_PARENT"));
		} catch (Exception ex) {
			ex.printStackTrace();
		}
